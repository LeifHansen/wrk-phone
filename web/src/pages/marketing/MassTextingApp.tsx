...
const FAQ = [
  ...
  { q: 'How many texts can I send at once?', a: 'WrkPhn paces sends at ~10 messages per second by default (well under Twilio\'s standard limits) and scales higher with 10DLC registration. You can send to thousands in one blast — recipients are queued atomically so a transient failure refunds credits, no stuck campaigns.' },
  { q: 'Will my mass texts be marked spam?', a: 'Not if you follow basic hygiene: opted-in lists, identifiable sender, and a STOP option (WrkPhn enforces this automatically). For volume sending, get a 10DLC-registered local number or verified toll-free — WrkPhn walks you through both.' },
  ...
  return (
    <MarketingPage
      ...
      benefits={[
        ...
        { icon: '🛡️', title: 'Carrier hygiene', body: 'STOP/HELP intercepted, opt-outs respected forever, 10DLC + toll-free verification walkthroughs in-app.' },
      ...
      deep={[
        { h2: 'Mass texting is a delivery problem', body: [
          ...
          'For senders pushing into the 10,000+ range, WrkPhn supports 10DLC for raised throughput (and walks you through the sole-prop onboarding wizard in-app), or Messaging Service / shared toll-free for volume without 10DLC.',
        ]},
